...
class TestAPIEndpoints:
    ...
    def test_multiple_predictions_different_patients(self, client):
        ...
        young_patient = {
            "age": 35.0, "sex": 0, "cp": 4, "trestbps": 120.0,
            "chol": 180.0, "fbs": 0, "restecg": 0, "thalach": 180.0,
            "exang": 0, "oldpeak": 0.0, "slope": 1, "ca": 0.0, "thal": 3.0
        }
        
        # Older patient with risk factors
        older_patient = {
            "age": 70.0, "sex": 1, "cp": 2, "trestbps": 160.0,
            "chol": 280.0, "fbs": 1, "restecg": 2, "thalach": 110.0,
            "exang": 1, "oldpeak": 3.5, "slope": 2, "ca": 3.0, "thal": 7.0
        }
    ...
    def test_batch_predict_with_multiple_patients(self, client):
        ...
        patients = [
            {"age": 45.0, "sex": 1, "cp": 3, "trestbps": 130.0,
             "chol": 200.0, "fbs": 0, "restecg": 0, "thalach": 150.0,
             "exang": 0, "oldpeak": 1.0, "slope": 2, "ca": 0.0, "thal": 3.0},
            {"age": 60.0, "sex": 1, "cp": 1, "trestbps": 150.0,
             "chol": 250.0, "fbs": 1, "restecg": 2, "thalach": 120.0,
             "exang": 1, "oldpeak": 2.5, "slope": 2, "ca": 2.0, "thal": 7.0},
            {"age": 50.0, "sex": 0, "cp": 4, "trestbps": 125.0,
             "chol": 190.0, "fbs": 0, "restecg": 0, "thalach": 160.0,
             "exang": 0, "oldpeak": 0.5, "slope": 1, "ca": 0.0, "thal": 3.0}
        ]
...
class TestDataValidation:
    ...
    def test_age_validation(self):
        ...
        # Valid age
        valid_data = {
            "age": 63.0, "sex": 1, "cp": 1, "trestbps": 145.0,
            "chol": 233.0, "fbs": 1, "restecg": 2, "thalach": 150.0,
            "exang": 0, "oldpeak": 2.3, "slope": 3, "ca": 0.0, "thal": 6.0
        }
